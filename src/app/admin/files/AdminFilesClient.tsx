...
export default function AdminFilesClient({ projects }: AdminFilesClientProps) {
      ...
      <div className="lg:col-span-3">
        {activeProject ? (
          ...
          <div className="bg-slate-900/40 border border-slate-900 rounded-3xl p-16 text-center text-slate-500 text-sm flex flex-col items-center justify-center gap-2">
            <FolderOpen className="w-8 h-8 text-slate-800" />
            <p>No projects available for file management. Create a project first!</p>
          </div>
        )}
      </div>
